 ...
 * de la rejilla y la llamada, la primera.
 */
  ...
  return (
    <section id="contacto" data-tono="oscuro" aria-labelledby="contact-title" className="relative bg-ink text-paper">
      <div className="container-editorial seccion">
        ...
        <div className="mt-8 flex flex-col gap-8 md:mt-12 lg:grid lg:grid-cols-[536fr_696fr] lg:items-start lg:gap-x-[88px] lg:gap-y-8">
          ...
          <div className="order-last border border-paper/28 p-6 sm:p-7 lg:order-none lg:col-start-1 lg:row-start-2">
          ...
          <p className="order-last text-[15px] leading-[1.6] text-paper/78 lg:order-none lg:col-start-1 lg:row-start-4">
            {anteEmail}
            <a
