...
export const T9 = {
  ...
  /** Se selecciona la columna rota entera (D2:D6). */
...
// propagación de los errores) los pone la música (build_short), y la última
// corchea va en silencio: aquí solo suena lo que se ve.
export const cues: SceneCues = {
  ...
  portrait: [
    ...
    // La succión: barrido descendente que muere en el contorno cerrado.
    {frame: T9.suck, sfx: "whooshDown", dur: 14, gain: 0.5},
