...
- **Titular:** «Software a medida para ordenar la gestión de tu negocio» (hasta el 26 de septiembre de 2026 decía «de tu pyme»). La entradilla nombra problemas reconocibles: reservas por WhatsApp, cobros en una hoja de cálculo, pedidos apuntados en papel.
...
- **Web de evento**: sin enlace externo. `evento/portada-movil.jpg` es una captura del móvil que aportó Alberto el 26 de septiembre de 2026 y que se publica sin difuminar, a petición suya: se ven el monograma, los nombres, la fecha, el lugar, «Confirmar asistencia» y la cuenta atrás. En la portada y en la ficha va el móvil solo, centrado en su escenario. En la ficha, por debajo de 768 px, se añade un recorte de la cuenta atrás. Sustituye a `cuenta-anonima.jpg` (monograma y fecha difuminados), retirada del árbol servido.
- **Web y app de radio**: sin enlace externo. Desde el 26 de septiembre de 2026 se enseñan dos capturas del móvil que aportó Alberto, sin difuminar y a petición suya: `radio/portada-movil.jpg` (portada con el nombre del programa y el botón del directo) y `radio/directo-movil.jpg` (el reproductor del directo). En las dos se ve el reproductor fijo de abajo. La portada, la ficha y su OG las ponen lado a lado. Se presenta como web y app del programa. Sustituyen a `portada-anonima.jpg` y `movil.jpg`, que estaban difuminadas y se retiraron del árbol servido.
